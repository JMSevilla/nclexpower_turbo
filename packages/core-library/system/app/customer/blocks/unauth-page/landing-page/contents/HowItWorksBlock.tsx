      ...
      <div className="w-full flex flex-col items-center">
        <div className="flex flex-col gap-5 items-center px-10 text-center">
          <p className="text-4xl font-bold ">
            <span className="text-[#0f2a71]">Step-by-step</span> till you pass!{" "}
          </p>
        ...
        <div className="w-4/6 flex items-center justify-center py-10 flex-wrap gap-5 lg:gap-0">
          <div className="w-1/3 min-w-[200px] flex items-center flex-col hover:scale-105 transition-all duration-300">
            <Image src={WatchVideos} alt="WatchVideos" />
            <p>
              Step 1 :{" "}
              <span className="text-[#0f2a71] font-bold">By Watching</span>
            </p>
          </div>
          <div className="w-1/3 min-w-[250px] flex items-center flex-col hover:scale-105 transition-all duration-300">
            <Image src={StudyCards} alt="StudyCards" />
            <p>
              Step 2 :{" "}
              <span className="text-[#0f2a71] font-bold">By Studying</span>
            </p>
          </div>
          <div className="w-1/3 min-w-[250px] flex items-center flex-col hover:scale-105 transition-all duration-300">
            ...
            <p>
              Step 3 :{" "}
              <span className="text-[#0f2a71] font-bold">By Doing</span>
            </p>
          </div>
        </div>
        <div className="lg:flex w-5/6 justify-center pt-10 ">
          <div className="lg:w-2/5 lg:pl-16 text-center lg:text-left flex flex-col gap-5">
            <p className="text-4xl font-bold">
              Watch <span className="text-[#0f2a71]"> How it Works</span>
            </p>
