...
import { ControlledCheckbox, TextField, Card } from '../../../../../../../../../../components';
  ...
  return (
    <FormProvider {...form}>
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: "space-between" }}>
        ...
        {isApproved ?
          <Chip sx={{ backgroundColor: '#16db65', color: '#f3f3f3' }} label="Approved" />
          :
          <Chip sx={{ backgroundColor: 'transparent', color: '#560bad', border: "1px solid #560bad" }} label="Pending" />
        }
      </Box>
      {isApproved ?
        <Box sx={{ width: "100%", display: 'flex', alignItems: 'center', justifyContent: "end", zIndex: 1 }}>
        ...
        <Box sx={{ width: "100%", display: 'flex', alignItems: 'center', justifyContent: "end", zIndex: 1 }}>
          <CustomPopover
            ...
            <Card sx={{ width: "100%", padding: 6, border: "1px solid #80ed99", zIndex: 1 }}>
