...
export const SuccessPage: React.FC<Props> = (props) => {
    ...
    const type_identifier = values.main_type == "Regular" ? 'regular' : 'case-study'
    ...
    return (
        <div data-testid={`${type_identifier}-question`} className='h-[650px] flex flex-col items-center justify-center p-5 gap-y-10'>
