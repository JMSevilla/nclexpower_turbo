...
export const ContactForm: React.FC<FormValues> = ({
  ...
  return (
    <>
      <Box className="relative flex justify-center mt-0 lg:mt-[-180px] mb-0 lg:mb-20">
        <Card
          className="h-auto w-full lg:w-[1120px] flex flex-col lg:flex-row bg-white justify-between drop-shadow-md"
          sx={{
            borderRadius: {
              sm: "0px",
              lg: "20px",
