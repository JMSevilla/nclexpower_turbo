...
import { loginSchema, LoginFormType } from "@repo/core-library/components/blocks/LoginFormBlock/validation";
        ...
        <Box sx={{ maxWidth: { xs: 'xl', lg: '3xl' }, }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Box sx={{ gridColumn: 'span 10', display: 'flex', alignItems: 'center', gap: 4 }}>
              <Button type="submit" variant="contained" fullWidth color="primary" sx={{ px: 4, py: 2 }} onClick={handleSubmit(onSubmit)}>
                Login
              </Button>
            </Box>
          </form>
