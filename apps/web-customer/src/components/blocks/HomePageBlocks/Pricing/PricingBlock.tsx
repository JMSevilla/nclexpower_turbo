      ...
      <div className="container flex flex-col gap-10">
        <div className="w-full justify-center items-center flex flex-col gap-5 ">
          <div className="w-full flex items-center justify-center gap-5">
            <p className="w-fit text-center text-4xl font-bold border-r-2 pr-2">
              Pricing
            </p>
            <div className="w-1/2 max-w-[450px] flex flex-col gap-2">
              ...
              <span className="flex gap-5">
                <button
                  className={`${nurseType === 0 ? "w-full" : "w-[80%] saturate-0 hover:scale-95"} bg-green-600 whitespace-nowrap transition-all duration-300 text-white py-5 text-lg rounded-lg flex items-center leading-4 px-5 text-left gap-2`}
                ...
                <button
                  className={`${nurseType === 1 ? "w-full" : "w-[80%] saturate-0 hover:scale-95"} bg-blue whitespace-nowrap transition-all duration-300 text-white py-5 text-lg rounded-lg flex items-center leading-4 px-5 text-left gap-2`}
          ...
          <div className="w-full px-10 flex flex-col gap-5 mt-8">
            <div className="flex gap-5 w-full justify-center flex-wrap ">
              {filteredItems && filteredItems.length > 0 ? (
                ...
                <div
                  className={`bg-gradient-to-tr ${nurseType === 0 ? "from-green-400 to-green-600 text-curveGray" : "from-blue to-cyan-700 text-white"} rounded-md shadow-md px-5 py-8 text-lg w-full text-center  font-semibold`}
                >
