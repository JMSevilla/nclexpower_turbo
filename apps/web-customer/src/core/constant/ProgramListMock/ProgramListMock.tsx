...
export const standardProgramList: StandardProgramListType[] = [
    ...
    },
    {
        ...
        sections: [
            { sectionId: "1", sectionType: 'video', sectionTitle: 'Day 1 Videos', sectionStatus: 'completed', sectionVideos: [{
                secVidId: "1", secVidTitle: 'Essential Parts of Cardiovascular System', secVidUrl: "https://www.youtube.com/watch?v=teRcrjGb5kk", secVidPlaceholder: videoPlaceholder, secVidDuration: '4:00', secVidAuthor: 'Arjon Rivera', secVidAuthorImg: authorSample, 
            ...
            {
                secVidId: "2", secVidTitle: 'Conduction of the Heart', secVidUrl: "https://www.youtube.com/watch?v=H2jA88pESko", secVidPlaceholder: videoPlaceholder, secVidDuration: '3:00', secVidAuthor: 'JM Sevilla', secVidAuthorImg: authorSample, 
