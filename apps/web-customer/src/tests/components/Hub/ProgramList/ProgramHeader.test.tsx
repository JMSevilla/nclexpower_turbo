...
import { ProgramHeader } from "../../../../components/blocks/HubBlocks/ProgramListBlock/ProgramHeader";
...
describe("ProgramHeader Component", () => {
    ...
    it("should render the component with correct title and subtitle", () => {
        ...
        const subtitle = screen.getByText("Key body systems covered over 13 days of study.");
