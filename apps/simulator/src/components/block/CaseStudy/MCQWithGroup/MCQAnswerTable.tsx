                    ...
                    <tbody >
                        {tableItem.rows.map((row, rowIndex) => (
                            <tr className='odd:bg-slate-200' key={rowIndex}>
                                ...
                                <td className='border w-fit py-2 text-center' key={'ColTwo'}> <Checkbox value={row.ColTwo} /></td>
                                <td className='border w-fit py-2 text-center' key={'ColThree'}><Checkbox value={row.ColThree} /></td>
                                <td className='border w-fit py-2 text-center' key={'ColFour'}><Checkbox value={row.ColFour} /></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
