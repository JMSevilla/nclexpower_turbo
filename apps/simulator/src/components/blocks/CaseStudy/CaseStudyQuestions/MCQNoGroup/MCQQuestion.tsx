...
import MCQAnswerTable from '@/components/blocks/CaseStudy/CaseStudyQuestions/MCQNoGroup/MCQAnswerTable';
import { CaseStudyMCQ } from '@/core/types/ssrData'
import React, { useState } from 'react'

export const MCQQuestion: React.FC<CaseStudyMCQ> = ({ questionaire }) => {
                ...
                <div key={questionIndex} className='w-full h-full p-5 flex'>
                    ...
                    <div className='h-full w-1/2 px-10 py-5 flex flex-col gap-5'>
                        <div className='w-full h-fit'>
                            <MCQAnswerTable table={questionItem.answer} />
                        </div>
                    </div>
                </div>
            )}
