...
export const SimulatorProvider: React.FC<React.PropsWithChildren<SsrSimulatorValues>> = ({
    children,
    data
}) => {
    ...
    const simulatorContent = hooks.useApi(
        async (api) => {
    ...
    return (
        ...
        >{children}</SimulatorGlobalsContext.Provider>
    )
}
